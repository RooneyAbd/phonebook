...
class CardController extends Controller
{
    ...
    {
        $params = array();
        $params['card'] = Card::model()->findByPK($id);
        if (Yii::app()->user->checkAccess('viewCard', $params)) {
	...
	public function actionUpdate($id)
	{
        $params = array();
        $params['card'] = Card::model()->findByPK($id);
        if (Yii::app()->user->checkAccess('updateCard', $params)) {
            $model = $this->loadModel($id);
	...
	public function actionDelete($id)
	{
        $params = array();
        $params['card'] = Card::model()->findByPK($id);
        if (Yii::app()->user->checkAccess('deleteCard', $params)) {
	...
	{
        if (Yii::app()->user->checkAccess('viewCards')) {
            $dataProvider = new CActiveDataProvider('Card');
            $this->render('index', array(
                'dataProvider' => $dataProvider,
            ));
